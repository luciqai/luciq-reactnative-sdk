...
public class RNLuciqSurveysModuleTest {

    private RNLuciqSurveysModule surveysModule = spy(new RNLuciqSurveysModule(mock(ReactApplicationContext.class)));
    ...
    public void mockMainThreadHandler() throws Exception {
        ...
        mockLuciqUtil = mockStatic(LuciqUtil.class);
    ...
    public void given$getAvailableSurveys_whenQuery_thenShouldCallNativeApiAndResolvePromise() {
        ...
        Mockito.doAnswer(surveyObjectToJsonAnswer).when(LuciqUtil.class);
        LuciqUtil.surveyObjectToJson(any(List.class));
