package ai.luciq.react.example;
...
public class RNLuciqExampleCrashReportingModule extends ReactContextBaseJavaModule {

    public RNLuciqExampleCrashReportingModule(ReactApplicationContext reactApplicationContext) {
    ...
    public void sendNativeFatalCrash() {
        throw new IllegalStateException("Unhandled IllegalStateException from Luciq Test App");
    }
