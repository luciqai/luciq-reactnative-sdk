...
public class RNLuciqSessionReplayModuleTest {
    private RNLuciqSessionReplayModule sessionReplayModule = new RNLuciqSessionReplayModule(null);
    ...
    public void testSetSyncCallback() throws Exception  {
            ...
            RNLuciqSessionReplayModule SRModule = spy(new RNLuciqSessionReplayModule(mock(ReactApplicationContext.class)));
            ...
            doAnswer((invocation) -> {
                ...
                return null;
            }).when(SRModule).sendEvent(eq(Constants.LCQ_SESSION_REPLAY_ON_SYNC_CALLBACK_INVOCATION), any());
