  ...
  const logToLuciq = () => {
    ...
    switch (luciqLogLevel) {
      case 'verbose':
        ...
        break;
      case 'debug':
        Luciq.logDebug(luciqLog);
        break;
      case 'info':
        Luciq.logInfo(luciqLog);
        break;
      case 'warn':
        Luciq.logWarn(luciqLog);
        break;
      case 'error':
  ...
  return (
    <ScrollView>
      <Screen>
          ...
          onPress={() => {
            navigation.navigate('SessionProfiler', {
              ...
              setIsEnabled: (enabled: boolean) => {
                ...
                Luciq.setSessionProfilerEnabled(enabled);
                navigation.goBack();
              },
            });
          }}
        ...
        <VerticalListTile title="Report submit Handler">
          <VStack>
            <ListTile
              ...
              onPress={() =>
                Luciq.onReportSubmitHandler(function (report) {
                  addItem('onReportSubmitHandler', {
                    ...
                    fields: [
                      ...
                      { key: 'Luciq Logs', value: report.luciqLogs.toString() },
                    ],
                  });
            ...
            <ListTile
              ...
              onPress={() => Luciq.onReportSubmitHandler(function () {})}
            />
        ...
        <VerticalListTile title="Luciq Logs">
          <VStack>
            <Select
              ...
              onValueChange={(value) => setLuciqLogLevel(value as any)}
            />
            ...
            <View style={styles.formContainer}>
              <View style={styles.inputWrapper}>
                <InputField
                  ...
                  onChangeText={(text) => setLuciqLog(text)}
                  value={luciqLog}
                />
              </View>
            </View>

            <Button mt="4" onPress={logToLuciq}>
              Log Message
            </Button>
          </VStack>
        </VerticalListTile>
